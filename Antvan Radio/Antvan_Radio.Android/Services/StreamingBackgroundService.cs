...
{
    [Service]
	[IntentFilter(new[] { ActionPlay, ActionPause, ActionTogglePlayback})]
    public class StreamingBackgroundService : Service, AudioManager.IOnAudioFocusChangeListener
    {
        ...
        private const string hyper_link = @"http://195.123.218.74:8000/live";
        ...
        private async void Play()
        {
            ...
            try {
                await player.SetDataSourceAsync(ApplicationContext, Android.Net.Uri.Parse(hyper_link));
